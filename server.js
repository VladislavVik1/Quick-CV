...
- Без сухих списков и перечислений, только естественный связный рассказ как для Резюме
- Текст не должен быть как книжный, пример - обычное резюме для работы, но и в то же время - читабельное с интересом.
`;
